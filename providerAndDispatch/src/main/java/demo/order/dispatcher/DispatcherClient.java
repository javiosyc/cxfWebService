...
public final class DispatcherClient {
	...
	public static final String WSDLFile = "http://localhost:8060/OrderProcessDOMProvider?wsdl";

	private static final String NAMESPACE ="http://provider.order.demo/";
	
	private static final String SERVICE_NAME = "OrderProcessDOMProviderService";
	
	private static final String SERVICE_PORT = "OrderProcessDOMProviderPort";
	...
	public static void main(String args[]) throws Exception {
        ...
        QName domProvider = new QName(NAMESPACE, SERVICE_NAME);
       
        QName portName = new QName(NAMESPACE, SERVICE_PORT);
